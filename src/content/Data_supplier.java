    ...
    private void bTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bTambahActionPerformed
        ...
        if(cekNama.equals("")&&cekKota.equals("")&&cekProvinsi.equals("")&&cekAlamat.equals("")&&cekHp.equals("")){
            ...
            if(JOptionPane.showConfirmDialog(null, "Anda Yakin Data Yang Anda Tambahkan Sudah Benar?","Menambahkan Data",JOptionPane.YES_NO_OPTION)== JOptionPane.YES_OPTION){
                try{
                        st = conn.createStatement();
                        String ifExsist = "SELECT * FROM sys_supplier WHERE supplier_name ='"+tNama.getText()+"' && supplier_city = '"+tKota.getText()+"' && supplier_province = '"+tProvinsi.getText()+"' && supplier_address = '"+tAlamat.getText()+"' && supplier_phone = '"+cekHp+"' ";
                        ...
                        if(rs.next()){
                            ...
                            JOptionPane.showMessageDialog(null,"Data Batal Disimpan!");
                                ...
                                try{
                                    String sql = "INSERT INTO sys_supplier VALUES (NULL,'"+tNama.getText()+"', '"+tKota.getText()+"', '"+tProvinsi.getText()+"', '"+tAlamat.getText()+"', '"+cekHp+"')";
                                    st = conn.createStatement();
              ...
              if(JOptionPane.showConfirmDialog(null, "Anda Yakin Data Yang Anda Tambahkan Sudah Benar?","Menambahkan Data",JOptionPane.YES_NO_OPTION)== JOptionPane.YES_OPTION){
                  try{
                        ...
                        if(rs.next()){
                            ...
                            try{
                             String sql = "UPDATE sys_supplier SET supplier_name ='"+tNama.getText()+"',supplier_city = '"+tKota.getText()+"', supplier_province = '"+tProvinsi.getText()+"', supplier_address = '"+tAlamat.getText()+"', supplier_phone = '"+cekHp+"' WHERE supplier_id = '"+tId.getText()+"'";
                             st = conn.createStatement();
                             st.executeUpdate(sql);
