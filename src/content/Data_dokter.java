...
public class Data_dokter extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tDataa.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
          ...
          JOptionPane.showMessageDialog(null, "Data Gagal Ditambahkan!");
            ...
            JOptionPane.showMessageDialog(null, "Data Gagal Ditambahkan!");
             ...
             if(JOptionPane.showConfirmDialog(null, "Anda Yakin Data Yang Anda Tambahkan Sudah Benar?","Menambahkan Data",JOptionPane.YES_NO_OPTION)== JOptionPane.YES_OPTION){
                try{
                    st = conn.createStatement();
                    String ifExsist = "SELECT * FROM sys_dokter WHERE dokter_name ='"+tNama.getText()+"' && dokter_title = '"+tGelar.getText()+"' && dokter_phone = '"+cekHp+"' ";
                    ...
                    if(rs.next()){
                        ...
                        JOptionPane.showMessageDialog(null,"Data Batal Disimpan!");
                         ...
                         try{
                            String sql = "INSERT INTO sys_dokter VALUES (NULL,'"+tGelar.getText()+"', '"+tNama.getText()+"', '"+cekHp+"')";
//                            System.out.println(sql);
    ...
    private void bUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bUbahActionPerformed
        ...
        if(cekId.equals("")&&cekNama.equals("")&&cekGelar.equals("")&&cekHp.equals("")&&cekHp.equals("")){
            JOptionPane.showMessageDialog(null, "Isi Data Terlebih Dahulu!");
            ...
            JOptionPane.showMessageDialog(null, "Data Gagal Ditambahkan!");
             ...
             if(JOptionPane.showConfirmDialog(null, "Anda Yakin Data Yang Anda Rubah Sudah Benar?","Mengubah Data",JOptionPane.YES_NO_OPTION)== JOptionPane.YES_OPTION){
                 try{
                        ...
                        rs = st.executeQuery(ifExsist);
                        if(rs.next()){
                            JOptionPane.showMessageDialog(null,"Nomor Telepon Sudah Pernah Digunakan!");
                            JOptionPane.showMessageDialog(null,"Data Batal Disimpan!");
                        }
                        else{   
                               try{
                                String sql = "UPDATE sys_dokter SET dokter_name ='"+tNama.getText()+"', dokter_title = '"+tGelar.getText()+"', dokter_phone = '"+cekHp+"' WHERE dokter_id = '"+tId.getText()+"'";
                                st = conn.createStatement();
                                st.executeUpdate(sql);
