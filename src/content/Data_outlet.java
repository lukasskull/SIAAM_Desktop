        ...
        if(cekNama.equals("")&&cekKota.equals("")&&cekProvinsi.equals("")&&cekAlamat.equals("")&&cekHp.equals("")){
          ...
          JOptionPane.showMessageDialog(null, "Data Gagal Ditambahkan!");
            ...
            if(JOptionPane.showConfirmDialog(null, "Anda Yakin Data Yang Anda Tambahkan Sudah Benar?","Menambahkan Data",JOptionPane.YES_NO_OPTION)== JOptionPane.YES_OPTION){
                try{
                        st = conn.createStatement();
                        String ifExsist = "SELECT * FROM sys_outlet WHERE outlet_name ='"+tNama.getText()+"' && outlet_city = '"+tKota.getText()+"' && outlet_province = '"+tProvinsi.getText()+"' && outlet_address = '"+tAlamat.getText()+"' && outlet_phone = '"+cekHp+"'";
                        ...
                        if(rs.next()){
                            ...
                            JOptionPane.showMessageDialog(null,"Data Batal Disimpan!");
                               ...
                               try{
                                String sql = "INSERT INTO sys_outlet VALUES (NULL,'"+tNama.getText()+"', '"+tKota.getText()+"', '"+tProvinsi.getText()+"', '"+tAlamat.getText()+"', '"+cekHp+"')";
                                st = conn.createStatement();
             ...
             if(JOptionPane.showConfirmDialog(null, "Anda Yakin Data Yang Anda Rubah Sudah Benar?","Mengubah Data",JOptionPane.YES_NO_OPTION)== JOptionPane.YES_OPTION){
               try{
                   st = conn.createStatement();
                        ...
                        rs = st.executeQuery(ifExsist);
                        if(rs.next()){
                            JOptionPane.showMessageDialog(null,"Data Outlet Sudah Pernah Disimpan!");
                            JOptionPane.showMessageDialog(null,"Data Batal Disimpan!");
                        }
                        else{   
                                try{
                                String sql = "UPDATE sys_outlet SET outlet_name ='"+tNama.getText()+"',outlet_city = '"+tKota.getText()+"', outlet_province = '"+tProvinsi.getText()+"', outlet_address = '"+tAlamat.getText()+"', outlet_phone = '"+cekHp+"' WHERE outlet_id = '"+tId.getText()+"'";
                                st = conn.createStatement();
                                st.executeUpdate(sql);
