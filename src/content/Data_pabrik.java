        ...
        if(cekNama.equals("")&&cekKota.equals("")&&cekProvinsi.equals("")&&cekAlamat.equals("")&&cekHp.equals("")){
            ...
            JOptionPane.showMessageDialog(null, "Data Gagal Ditambahkan!");
             ...
             if(JOptionPane.showConfirmDialog(null, "Anda Yakin Data Yang Anda Rubah Sudah Benar?","Mengubah Data",JOptionPane.YES_NO_OPTION)== JOptionPane.YES_OPTION){
                try{
                    st = conn.createStatement();
                    String ifExsist = "SELECT * FROM sys_pabrik WHERE pabrik_name = '"+tNama.getText()+"'&&pabrik_city = '"+tKota.getText()+"'&&pabrik_province = '"+tProvinsi.getText()+"'&&pabrik_address = '"+tAlamat.getText()+"'&& pabrik_phone = '"+cekHp+"' ";
                    rs = st.executeQuery(ifExsist);
                    if(rs.next()){
                        JOptionPane.showMessageDialog(null,"Data Pabrik Sudah Pernah Disimpan!");
                        JOptionPane.showMessageDialog(null,"Data Batal Disimpan!");
                    }
                    else{   
                        try{
                            String sql = "UPDATE sys_pabrik SET pabrik_name ='"+tNama.getText()+"',pabrik_city = '"+tKota.getText()+"', pabrik_province = '"+tProvinsi.getText()+"', pabrik_address = '"+tAlamat.getText()+"', pabrik_phone = '"+cekHp+"' WHERE pabrik_id = '"+tId.getText()+"'";
                            st = conn.createStatement();
        ...
        if(cekNama.equals("")&&cekKota.equals("")&&cekProvinsi.equals("")&&cekAlamat.equals("")&&cekHp.equals("")){
            ...
            if(JOptionPane.showConfirmDialog(null, "Anda Yakin Data Yang Anda Tambahkan Sudah Benar?","Menambahkan Data",JOptionPane.YES_NO_OPTION)== JOptionPane.YES_OPTION){
                try{
                    ...
                    rs = st.executeQuery(ifExsist);
                    if(rs.next()){
                        JOptionPane.showMessageDialog(null,"Data Nama Pabrik Sudah Pernah Disimpan!");
                        JOptionPane.showMessageDialog(null,"Data Batal Disimpan!");
                    }
                    else{   
                        try{
                           String sql = "INSERT INTO sys_pabrik VALUES (NULL,'"+tNama.getText()+"', '"+tKota.getText()+"', '"+tProvinsi.getText()+"', '"+tAlamat.getText()+"', '"+cekHp+"')";
                           st = conn.createStatement();
                           st.executeUpdate(sql);
