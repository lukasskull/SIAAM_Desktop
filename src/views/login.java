    ...
    private void login(){
        ...
        if(cekUname.equals("")&&cekPass.equals("")){
            ...
            JOptionPane.showMessageDialog(null, "Gagal Login!");
              ...
              try{
                String uname = tUname.getText().trim().replaceAll("\\s","");
                String pass  = tPass.getText().trim().replaceAll("\\s","");
                
                String sql = "SELECT * FROM sys_karyawan JOIN sys_password ON sys_karyawan.karyawan_id = sys_password.password_karyawan_id WHERE karyawan_username = '"+uname+"' AND password_value = MD5('"+pass+"')";
                ...
                if(rs.next()){
                    ...
                    switch (rs.getInt("karyawan_role_id")) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            kepala_gudang k = new kepala_gudang();
                            k.show();
                            break;
                        case 4:
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            JOptionPane.showMessageDialog(null,"ENTAH APA YANG MERASUKI MU TAPI ROLENYA KOK GAK KEDAFTAR YA!!!!");
                            break;
                    }
                }else{
